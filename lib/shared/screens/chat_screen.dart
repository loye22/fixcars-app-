...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Wallpaper layer - subtle and elegant
          Positioned.fill(
            child: Image.asset(
              'assets/ww.jpg',
              fit: BoxFit.cover,
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    const Color(0xFF0F1419).withOpacity(0.78),
                    const Color(0xFF12181E).withOpacity(0.85),
                  ],
                ),
              ),
            ),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SupplierProfileScreen(userId: widget.otherUserUuid),
                    ),
                  );
                },
                child: Container(
                ...
                child: _conversationId == null
                  ...
                  builder: (context, snapshot) {
                    ...
                    for (final doc in docs) {
                      ...
                      final isIncoming = data['sender_id'] != _chatService.userUuid;
                    ...
                    if (hasUnreadIncoming && !_isMarkingRead) {
                      _isMarkingRead = true;
                      _chatService.markMessagesAsRead(conversationId: _conversationId!).whenComplete(() {
                    ...
                    return ListView.builder(
                      key: _conversationId == null ? null : PageStorageKey<String>('chat_$_conversationId'),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final replyToMessageId = data['reply_to_message_id'] as String?;
                        ...
                        final msgKey = _messageKeys.putIfAbsent(doc.id, () => GlobalKey());
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    // Reply (if present) - always at top
                                    if (replyTo != null)
                                      Container(
                                        padding: const EdgeInsets.all(8),
                                        margin: const EdgeInsets.only(bottom: 8),
                                        decoration: BoxDecoration(
                                          color: isMe ? const Color(0xFF1A8A7E).withOpacity(0.7) : const Color(0xFF2C3A47),
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (_) => ExtendedImageSlidePage(
                        ...
                        //                 decoration: BoxDecoration(
                        //                   color: isMe
                        //                       ? const Color(0xFF1A8A7E).withOpacity(0.7)
  ...
  Icon _statusIcon(String status) {
    switch (status) {
      case 'read':
        return const Icon(Icons.done_all, size: 16, color: Color(0xFF53E0C6));
      default:
  ...
  Future<void> _ensureConversation() async {
    ...
    final id = await _chatService.getOrCreateConversation(otherUserUuid: widget.otherUserUuid);
    if (!mounted) return;
    setState(() {
      _conversationId = id;
  ...
  Future<void> _loadOtherUserProfile() async {
    try {
      ...
      if (!mounted) return;
      setState(() {
        _otherUserName = data['full_name'] as String? ?? data['display_name'] as String?;
        _otherUserPhotoUrl = data['photo_url'] as String? ?? data['profile_photo_url'] as String?;
      });
    } catch (_) {}
  }
      ...
      child: Row(
        children: [
          Container(
            ...
            child: IconButton(
              icon: Image.asset('assets/clipper.png', width: 24, color: Colors.white),
              onPressed: () async => await widget.onPickImageFromGallery(),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    icon: Image.asset('assets/camera2.png', width: 24, color: Colors.white),
                    onPressed: () async => await widget.onTakePicture(),
                  ),
                ],
              ),
            ),
          ...
          Container(
            ...
            child: IconButton(
              icon: Image.asset('assets/send.png', width: 24, color: Colors.white),
              onPressed: () async {
                if (_hasText) {
...
class _ReplyBannerState extends State<_ReplyBanner> with SingleTickerProviderStateMixin {
        ...
        return Transform.translate(
          ...
          child: Opacity(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF1F2A38).withOpacity(0.95),
                borderRadius: BorderRadius.circular(16),
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFF14B8A6), Color(0xFF54DBCC)],
                      ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.reply, size: 20, color: Color(0xFF14B8A6)),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
