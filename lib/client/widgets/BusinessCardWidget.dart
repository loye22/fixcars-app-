...
class BusinessCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //                       SizedBox(width: 4),
    //                       Text('$rating ' , style: TextStyle(color: Color(0xFF000000)),),
    //                       Text('($reviewCount recenzii)' , style: TextStyle(color: Color(0xFF6B7280))),
    //                     ],
    //                   ),
    //                   SizedBox(height: 10),
    //                   Row(
    ...
    //                       SizedBox(width: 4),
    //                       Flexible(
    //                         child: Text('$distance \u2022 $location' ,  style: TextStyle(color: Color(0xFF6B7280))),
    //                       ),
    //                     ],
    //                   ),
    //                   SizedBox(height: 4),
    ...
    //                       SizedBox(width: 4),
    //                       Text(isAvailable ? 'Disponibil acum' : 'Nu este disponibil'),
    //                     ],
    //                   ),
    //                   SizedBox(height: 8),
    //                 ],
