...
class _MecanicScreenState extends State<MecanicScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    if (!hasLocationChanged && !hasBrandChanged && !hasServicesChanged && _mechanicServices.isNotEmpty) {
  ...
  //  print('After setState - selected brand: ${_selectedBrand?['brand_name']}');
    _fetchData(); // Trigger API call with new brand filter
  }
