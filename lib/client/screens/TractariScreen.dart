...
class _TractariScreenState extends State<TractariScreen> {
  ...
  final MecanicAutoService _tractariService = MecanicAutoService();
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      List<Map<String, dynamic>> services = await _tractariService.fetchMecanicAutos(
        category: AutoService.tractari_auto,
        lat: _currentLat,
        lng: _currentLng,
